 ...
 *     description: Retrieve all products with optional search by name/description and filters by price, category, or subcategory.
 *     tags: [Products]
 *     parameters:
 *       - in: query
 *         name: q
 ...
 *     responses:
 *       200:
 *         description: List of products matching search/filter criteria
 *         content:
 *           application/json:
 *             schema:
 *               type: array
